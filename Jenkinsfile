pipeline {
    ...
    IMAGE_REPO="public.ecr.aws/q6b5k7v4/mindtree"
    }
    stages {
        stage('Checkout Code') {
            steps {
                echo "Checking out source code"
                git 'https://github.com/rishabhgupta2408/Rishabh-project-CI-CD'
        ...
        stage('Build & Push Docker Image') {
            ...
            steps {
                sh '''
                    ...
                    aws ecr-public get-login-password --region us-east-1 | docker login --username AWS --password-stdin public.ecr.aws/q6b5k7v4
